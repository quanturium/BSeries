...
public class TwitterApp {
	...
	public void authorize() {
		mProgressDlg.setMessage("Initialisation");
		mProgressDlg.show();
	...
	public void processToken(String callbackUrl)  {
		mProgressDlg.setMessage("Finalisation");
		mProgressDlg.show();
	...
	private void showLoginDialog(String url) {
		...
		TwitterDialog twD = new TwitterDialog(context, url, listener);
		twD.setCanceledOnTouchOutside(false);
		twD.show();		
	}
